# Generated by Powerlevel10k configuration wizard on 2025-05-31 at 18:48 -03.
...
() {
  ...
  function my_git_formatter() {
    ...
    # Host/forge icon - single source (core visual identifier disabled below).
    # Green via ${clean} to match the other icons; generic git glyph as fallback.
    local host_icon
    case $VCS_STATUS_REMOTE_URL in
      (*github.com*)    host_icon=$'\uf113' ;;
      (*gitlab.com*)    host_icon=$'\uf296' ;;
      (*bitbucket.org*) host_icon=$'\uf171' ;;
      (*codeberg.org*)  host_icon=$'\uf330' ;;
      (*forgejo*)       host_icon=$'\uf335' ;;
      (*gitea*)         host_icon=$'\uf339' ;;
      (*)               host_icon=$'\uf1d3' ;;
    esac
